...
public class TagDAO implements DAO<Tag>{
    ...
    public void create(Tag tag) {
        ...
        int rows = jdbcTemplate.update(sql, tag.getName(), rowMapper);
    }
    ...
    public void update(Tag tag, String id) {
        ...
        int rows = jdbcTemplate.update(sql, tag.getName(), id, rowMapper);
    }

    @Override
    public void delete(String id) {
        String sql = "DELETE TAG Where name = ?";
        int rows = jdbcTemplate.update(sql, id, rowMapper);
    }
}
